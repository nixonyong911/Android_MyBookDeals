...
public class bookCategories extends ActionBarActivity implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //User
        fetchBookData(new Book(message));
    }
    ...
    private void fetchBookData(final Book book) {
        ...
        serverRequest.fetchBookDataAsyncTask(book, new GetBookListCallback() {
            @Override
